...
// create all 8 directions
// move in all 8 direction and compare the word with the matrix elements
// finally if all words are matched we return true else false
